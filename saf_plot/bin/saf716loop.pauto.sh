...
grd2cpt data1.grd -Crainbow -V >$title.p.cpt
...
4.09 5.3 8 0 0 0 Mean normal stress 
...
psscale -D7.035c/7.3c/2.06c/0.18ch -C${cpt_path}$title.p.cpt   -B15 -S  -O -K -V>> ${psfile}
