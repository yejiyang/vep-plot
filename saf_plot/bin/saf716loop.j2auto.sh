...
grd2cpt data1.grd -Crainbow -V >$title.j2.cpt
mv $title.j2.cpt ${cpt_path}
...
grdimage data1.grd -I${para_path}scatopo_gradient1.grd  -C${cpt_path}$title.j2.cpt -J  -K -V  -O >>$psfile
...
psscale -D7.035c/7.3c/2.06c/0.18ch -C${cpt_path}$title.j2.cpt   -B15 -S  -O -K -V>> ${psfile}
...
ps2pdf ${psfile} ${title}.j2auto.pdf
