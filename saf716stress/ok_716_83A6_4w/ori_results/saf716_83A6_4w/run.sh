...
# get data
cp /Users/jiyang/opensource/vep-plot/saf716stress/orig/oress.saf716_83A6_4w.tgz ./
tar -xzvf oress.saf716_83A6_4w.tgz

# for 716 meter
#ifort -o pp12345 pp12345.f
gfortran -o pp12345 pp12345.f
./pp12345
mv cgrid.meter.m.txt sagrid.meter.83A6_4w.txt
mv beachball.meter.txt beachball.meter.83A6_4w.txt
cp sagrid.meter.83A6_4w.txt ../../input/
cp beachball.meter.83A6_4w.txt ../../input/
