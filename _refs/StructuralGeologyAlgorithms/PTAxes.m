...
%         plunge of the slip vector should be 90/-30
%
...
for i=1:size(fault,1)
    ...
    %Else if slip vector is pointing up
    else
        %P orientation
        [P(i,1),P(i,2)] = CartToSph(V(1,1),V(2,1),V(3,1));
        %T orientation
        [T(i,1),T(i,2)] = CartToSph(V(1,3),V(2,3),V(3,3));
    end
end
